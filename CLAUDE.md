...
This is a Logseq graph - a knowledge management system that uses markdown files and bi-directional linking.
...
### Journal Files
- Journal files are named by date, typically in `yyyy-MM-dd` format (e.g., `2025-12-23.md`)
- Using `yyyy/MM/dd` format creates hierarchical namespacing, giving you automatic month and year pages
- Journal file naming format can be customized to include additional information like day of week
